...
func (r *accountRepository) accountListFilteredQuery(platform, accountType, planType, status, search string, groupID int64, privacyMode, subscriptionExpiry string) *dbent.AccountQuery {
...
func (r *accountRepository) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, planType, status, search string, groupID int64, privacyMode, subscriptionExpiry string) ([]service.Account, *pagination.PaginationResult, error) {
	q := r.accountListFilteredQuery(platform, accountType, planType, status, search, groupID, privacyMode, subscriptionExpiry)
