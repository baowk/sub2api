...
func (s *accountRepoStub) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, planType, status, search string, groupID int64, privacyMode, subscriptionExpiry string) ([]Account, *pagination.PaginationResult, error) {
